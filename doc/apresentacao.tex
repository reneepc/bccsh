...
\begin{figure}[!htb]
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{imgs/contex5-2.png}
  \caption{M2, 5 threads}\label{fig:awesome_image1}
\endminipage\hfill
\minipage{0.32\textwidth}
  \includegraphics[width=\linewidth]{imgs/contex50-2.png}
  \caption{M2, 50 threads}\label{fig:awesome_image2}
\endminipage\hfill
\minipage{0.32\textwidth}%
  \includegraphics[width=\linewidth]{imgs/contex500-2.png}
  \caption{M2, 500 threads}\label{fig:awesome_image3}
\endminipage
\end{figure}
